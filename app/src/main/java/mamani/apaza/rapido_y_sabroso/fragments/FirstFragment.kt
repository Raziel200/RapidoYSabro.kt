...
class FirstFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        featuredModelsList.add(FeaturedModel(R.drawable.ver1, "Featured 1", "Description 1"))
        featuredModelsList.add(FeaturedModel(R.drawable.ver2, "Featured 2", "Description 2"))
        featuredModelsList.add(FeaturedModel(R.drawable.ver3, "Featured 3", "Description 3"))
        ...
        featuredVerModelList.add(FeaturedVerModel(R.drawable.aji, "Featured 1", "Descripcion 1", "4.8", "10:00 - 8:00"))
        featuredVerModelList.add(FeaturedVerModel(R.drawable.ver2, "Featured 2", "Descripcion 2", "4.8", "10:00 - 8:00"))
